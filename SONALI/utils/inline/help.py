...
def help_pannel(page: int = 1):
    if page == 1:
        buttons = [
            ...
            [InlineKeyboardButton(text="Next ➡", callback_data="help_page 2")],
        ...
        buttons = [
            ...
            [InlineKeyboardButton(text="⬅ Previous", callback_data="help_page 1"),
             InlineKeyboardButton(text="Next ➡", callback_data="help_page 3")],
            [InlineKeyboardButton(text="❌ Close", callback_data="close")]
        ]
        ...
        buttons = [
            ...
            [InlineKeyboardButton(text="⬅ Previous", callback_data="help_page 2")],
            [InlineKeyboardButton(text="❌ Close", callback_data="close")]
        ]
