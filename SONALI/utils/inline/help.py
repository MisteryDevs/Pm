...
def first_page(_):
	controll_button = [InlineKeyboardButton(text="◁", callback_data="last_page"), InlineKeyboardButton(text="HOME", callback_data="settingsback_helper"), InlineKeyboardButton(text="▷", callback_data="second_page")]
...
def second_page(_):
	controll_button = [InlineKeyboardButton(text="◁", callback_data="first_page"), InlineKeyboardButton(text="HOME", callback_data="settingsback_helper"), InlineKeyboardButton(text="▷", callback_data="third_page")]
...
def third_page(_):
	controll_button = [InlineKeyboardButton(text="◁", callback_data="second_page"), InlineKeyboardButton(text="HOME", callback_data="settingsback_helper"), InlineKeyboardButton(text="▷", callback_data="fourth_page")]
...
def fourth_page(_):
	controll_button = [InlineKeyboardButton(text="◁", callback_data="third_page"), InlineKeyboardButton(text="HOME", callback_data="settingsback_helper"), InlineKeyboardButton(text="▷", callback_data="first_page")]
