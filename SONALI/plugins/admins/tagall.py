...
TAGMES = ["𝐎𝐲𝐞 𝐒𝐨 𝐆𝐲𝐞 𝐊𝐲𝐚 𝐎𝐧𝐥𝐢𝐧𝐞 𝐀𝐚𝐨😊 ",
...
async def mentionall(client, message):
    ...
    async for usr in client.get_chat_members(chat_id):
        ...
        usrnum += 1
        username = f"@{usr.user.username}" if usr.user.username else usr.user.first_name
        usrtxt += f"{username} "

        if usrnum == 5:  # 5 members tag hone ke baad message bhejna
