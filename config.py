...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/princesinff/ALPHA_MUSIC",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/APNA_CLUB_09")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/SWEETY_BOT_UPDATE")
